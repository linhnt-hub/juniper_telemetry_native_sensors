...
import (
	...
	_ "github.com/linhnt-hub/juniper_telemetry_native_sensors/plugins/input/juniper_telemetry_native_sensors" // Example external package for showing where you can import your plugins
